...
public class AdmUsuarioBean implements  Serializable {
    ...
    public void guardar() {
        ...
        try {
            ...
            admusuario.setPassword(SesionBean.encriptarSHA512(admusuario.getPassword()));
            admusuario.setFechaCreacion(date);
            admusuario.setFechaModificacion(date);
            fechaCaducidad();
            admusuario.setFechaCaducidad(date);
    ...
    //metodoq ue busca los id de cada uno de los item seleccionados en la vista
  ...
  public void asignarCiudad(){
	 ...
	 // d.setIdDetalleCatalogo(ciudadC);
