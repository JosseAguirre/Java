 ...
 */
@Entity
@Table(name="ope_detalle_transaccion_tmp", schema = "java")
@NamedQuery(name="OpeDetalleTransaccionTmp.findAll", query="SELECT o FROM OpeDetalleTransaccionTmp o")
public class OpeDetalleTransaccionTmp implements Serializable {
	...
	public OpeDetalleTransaccionTmp() {
	}
