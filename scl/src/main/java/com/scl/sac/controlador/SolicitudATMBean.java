...
@ManagedBean
@ViewScoped
public class SolicitudATMBean implements Serializable {
 ...
 public void total(){
		    ...
		    public void mostrar(){
		    	System.out.println("xxxxx"+tipoSolicitud);
		    	if(tipoSolicitud.equals("atm")){
		    		verAtm = true;
		    		System.out.println("qqqqq");
		    		
		    	}
		    	if(tipoSolicitud.equals("bajoPedido")){
		    		verBp = true;
		    		System.out.println("eeee");
		    		
		    	}
		    	if(tipoSolicitud.equals("intercambio")){
		    		verIntercambio = true;
			...
			public boolean isVerAtm() {
				return verAtm;
			}



			public void setVerAtm(boolean verAtm) {
				this.verAtm = verAtm;
			}



			public boolean isVerIntercambio() {
				return verIntercambio;
			}



			public void setVerIntercambio(boolean verIntercambio) {
				this.verIntercambio = verIntercambio;
			}



			public boolean isVerBp() {
				return verBp;
			}



			public void setVerBp(boolean verBp) {
				this.verBp = verBp;
			}
